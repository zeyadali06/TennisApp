...
class _MapViewBodyState extends State<MapViewBody> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SearchForLocationCubit, SearchForLocationState>(
      builder: (context, state) {
        return ModalProgressHUD(
          inAsyncCall: state is SearchForLocationLoading,
          child: Scaffold(
            appBar: AppBar(
              automaticallyImplyLeading: false,
              leading: IconButton(
                onPressed: () {
                  return Navigator.pop<PositionEntity>(
                      context, _positionEntity);
                },
                    ...
                    child: TextField(
                      ...
                      onSubmitted: (value) {
                        BlocProvider.of<SearchForLocationCubit>(context)
                            .searchForLocation(_searchController.text.trim());
                      },
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                              ...
                              title: Text(state.suggestions[index].place),
                              onTap: () async {
                                _searchController.text =
                                    state.suggestions[index].place;
